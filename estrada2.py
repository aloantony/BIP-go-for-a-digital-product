...
def squat():
    ...
    sleep(0.5)
    bus.write(f"#{SERVO_A_ID}D{-8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
    bus.write(f"#{SERVO_B_ID}D{-8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
    bus.write(f"#{SERVO_C_ID}D{-8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
    sleep(0.5)
    bus.write(f"#{SERVO_A_ID}D{8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
    bus.write(f"#{SERVO_B_ID}D{8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
    bus.write(f"#{SERVO_C_ID}D{8/2*NUM_PI}T{MOVE_TIME_MS}\r".encode())
